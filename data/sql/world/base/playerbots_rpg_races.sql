...
-- Baercraft custom race compatibility (v5.9)
-- High Elf (13) inherits Blood Elf (10) RPG locations.
INSERT INTO `playerbots_rpg_races` (`entry`, `race`, `minl`, `maxl`)
SELECT `entry`, 13, `minl`, `maxl` FROM `playerbots_rpg_races` WHERE `race` = 10;

-- Mag'har (14) inherits Orc (2) RPG locations.
INSERT INTO `playerbots_rpg_races` (`entry`, `race`, `minl`, `maxl`)
SELECT `entry`, 14, `minl`, `maxl` FROM `playerbots_rpg_races` WHERE `race` = 2;
